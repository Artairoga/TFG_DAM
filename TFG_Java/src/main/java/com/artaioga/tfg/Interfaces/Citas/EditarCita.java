 ...
 * @author artai
 */
public class EditarCita extends javax.swing.JDialog {

    /**
     * Creates new form EditarCita
     */
    public EditarCita(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarCita dialog = new EditarCita(new javax.swing.JFrame(), true);
